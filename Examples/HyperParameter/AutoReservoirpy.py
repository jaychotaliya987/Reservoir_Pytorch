...
vardict_path = path + "/lorenz_vardict.json"
...
plt.tight_layout()
fig1_path = path + "/lorenz_prediction.png"
...
plt.tight_layout()
fig2_path = path + "/lorenz_hyper_analysis.png"
...
summary_path = path + "/lorenz_summary.json"
